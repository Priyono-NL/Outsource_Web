...
const OsTraining = () => {
  ...
  const handleImport = async (e) => {
    ...
    try {
      const res = await api.post('/ostraining/upload', formData, { headers: { 'Content-Type': 'multipart/form-data' } });
  ...
  return (
    <div>
      ...
      <div className="app-card">
        <OsTrainingTable refreshTrigger={crud.refreshKey} onEditClick={crud.handleEdit} searchTerm={crud.appliedSearch} />
      </div>
    </div>
  );
};
