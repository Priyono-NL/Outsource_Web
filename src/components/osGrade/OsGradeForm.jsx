...
function OsGradeForm({ onClose, onSuccess, initialData }) {
  ...
  useEffect(() => {
    if (initialData && formRef.current) {
      ...
      // Sinkronisasi data field original bagian bawah Anda (FIXED: Menggunakan .grade bukan .grade_id)
          ...
          <div className="modal-content border-0 shadow-lg" style={{ borderRadius: '8px', overflow: 'hidden' }}>
            ...
            <div className="d-flex justify-content-between align-items-center p-2 px-3 border-bottom bg-white">
              <h6 className="fw-bold mb-0" style={{ color: 'var(--color-primary)' }}>
                ...
                {initialData ? 'Edit Grade Kerja' : 'Tambah Grade Kerja'}
              </h6>
            ...
            <form ref={formRef} onSubmit={handleSave}>
              <div className="modal-body p-3 bg-white">
                ...
                {/* ======================================================== */}
                {/* BAGIAN INPUT ISIAN ASLI GRADE KERJA (100% ORIGINAL)       */}
                {/* ======================================================== */}
                <div className="row g-2">
                  <div className="col-12 mb-1">
                    <label className="form-label mb-1" style={{ fontSize: '0.75rem', fontWeight: '600' }}>Grade Kerja</label>
                    <div className="input-group input-group-sm">
