            ...
            <form ref={formRef} onSubmit={handleSave}>
              <div className="modal-body p-4 bg-white">
                ...
                <div className="hr-text text-muted small fw-bold mb-4">
                  <span className="bg-white px-2">Kategori & Jabatan</span>
                </div>
                    ...
                    <div className="d-flex justify-content-between">
                      ...
                      <div className="form-check">
                        <input 
                          ...
                          disabled={(!isEmployeeFound && !isEditMode) || isSearching}
                        />
                        <label className="form-check-label small fw-bold text-primary" htmlFor="no_limit_type" style={{ cursor: 'pointer' }}>
                          No Limit
                        </label>
                      </div>
                    </div>
